    	...
    	<div class="section_w800">
           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="0">
             <tr>
               ...
               <td width="95%"><p class="style1"><strong>CFI HeadQuarters</strong></p>
               <p class="style1"><strong>Ghatkopar East</strong></p>
               <p class="style1"><strong>Mumbai</strong></p></td>
             </tr>
             <tr>
               <td><img src="images/call.png" width="32" height="32" /></td>
             <td><p class="style1"><strong>0 1111111111</strong></p>
               <p class="style2">0 2222222222</p></td>
             </tr>
             <tr>
               <td><img src="images/mail.png" width="32" height="32" /></td>
               <td><span class="style1"><strong>info@cfi.com</strong></span></td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
